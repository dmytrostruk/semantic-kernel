...
/// <summary>
/// Options when creating a <see cref="EntityFrameworkVectorStoreRecordCollection{TRecord}"/>.
/// </summary>
public sealed class EntityFrameworkVectorStoreRecordCollectionOptions<TRecord> where TRecord : class
{
    /// <summary>
